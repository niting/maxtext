    ...
    def _kernel_impl(
      ...
      def perform_add(
        ...
        if not is_bf16:
          ...
          new_scratch_layout = ir.StridedLayoutAttr.get(0, [col_chunk_size, 1])
      ...
      new_input_ref_ty = ir.MemRefType.get(new_input_shape, bf16, memory_space=memoryspace_hbm)
      ...
      if topk_weights is not None:
        ...
        new_weights_ref_ty = ir.MemRefType.get(new_weights_shape, bf16, memory_space=memoryspace_hbm)
      ...
      with ir.InsertionPoint(loop_col_chunk.body):
        ...
        if is_bf16:
          ...
          new_input_layout = ir.StridedLayoutAttr.get(0, [mem_num, 1])
